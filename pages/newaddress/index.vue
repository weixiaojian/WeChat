	...
	export default {
		...
		methods: {
			...
			echoData(item){
				...
				this.provinces = this.addressInfo.provice?`${this.addressInfo.provice}/${this.addressInfo.city||''}/${this.addressInfo.country||''}${this.addressInfo.townName?'/'+this.addressInfo.townName:''}`:'请选择省市区' ;
