...
/***/ 86:
/*!********************************************************************************!*\
  !*** E:/idea-work/imwj/WeChat/main.js?{"page":"pages%2Forder%2Fsend%2Findex"} ***!
  \********************************************************************************/
...
/***/ 87:
/*!***********************************************************!*\
  !*** E:/idea-work/imwj/WeChat/pages/order/send/index.vue ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ 88:
/*!******************************************************************************************************!*\
  !*** E:/idea-work/imwj/WeChat/pages/order/send/index.vue?vue&type=template&id=fb1e2936&scoped=true& ***!
  \******************************************************************************************************/
...
/***/ 90:
/*!************************************************************************************!*\
  !*** E:/idea-work/imwj/WeChat/pages/order/send/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 91:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/idea-work/imwj/WeChat/pages/order/send/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuex = __webpack_require__(/*! vuex */ 13);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var SendReceive = function SendReceive() {__webpack_require__.e(/*! require.ensure | pages/order/components/send-receive/index */ "pages/order/components/send-receive/index").then((function () {return resolve(__webpack_require__(/*! ../components/send-receive/index.vue */ 442));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var GoodsInfo = function GoodsInfo() {__webpack_require__.e(/*! require.ensure | pages/order/components/goods-info/index */ "pages/order/components/goods-info/index").then((function () {return resolve(__webpack_require__(/*! ../components/goods-info/index.vue */ 449));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var ExpectTime = function ExpectTime() {__webpack_require__.e(/*! require.ensure | pages/order/components/expectTime/index */ "pages/order/components/expectTime/index").then((function () {return resolve(__webpack_require__(/*! ../components/expectTime/index.vue */ 456));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var Agreement = function Agreement() {__webpack_require__.e(/*! require.ensure | pages/order/components/agreement/index */ "pages/order/components/agreement/index").then((function () {return resolve(__webpack_require__(/*! ../components/agreement/index.vue */ 463));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var BlePop = function BlePop() {__webpack_require__.e(/*! require.ensure | components/ble-pop/ble-pop */ "components/ble-pop/ble-pop").then((function () {return resolve(__webpack_require__(/*! @/components/ble-pop/ble-pop.vue */ 428));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var YDTOAST = function YDTOAST() {__webpack_require__.e(/*! require.ensure | components/yd-toast/yd-toast */ "components/yd-toast/yd-toast").then((function () {return resolve(__webpack_require__(/*! @/components/yd-toast/yd-toast.vue */ 20));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
var self,timer = null;var _default =
{
  ...
  (0, _vuex.mapGetters)([_gettersType.GET_CONNECT_DEVICEId])),
  ...
  methods: {
    //去连接蓝牙
    goConnectBle: function goConnectBle() {
      uni.navigateTo({
        url: '/pages/myPrinter/myPrinter?pageId=send' });
    ...
    checkDispByCity: function checkDispByCity() {
      var self = this;
      var city = this.addressDataSJ ? this.addressDataSJ.city : false;
      if (city) {
        var data = { city: this.addressDataSJ.city };
      ...
      uni.getClipboardData({
        success: function success(res) {
          ...
          if (res.data != null && res.data != undefined && self.$Reg.removeHTMLTag(res.data) != '' && res.data.trim() != '') {
            ...
            self.isCopyText = self.$Reg.removeHTMLTag(res.data);
            if (self.isCopyText && (self.isCopyText.includes('省') || self.isCopyText.includes('市') || self.isCopyText.includes('区') || self.isCopyText.includes('洲') || self.isCopyText.includes('街道'))) {
              self.analysis();
            }
          }
        },
    ...
    analysis: function analysis() {
      ...
      self.$api.addressAnalysis(Data_).then(function (res) {
        if (res.code == 200) {
          ...
          self.smartObj.detailAddress = self.$Reg.stripscript(res.data.formatAddress) || '';
    ...
    // 订单提交
    submit: function submit(num) {var _this3 = this;
      var self = this;
      ...
      var data = {
        ...
        productType: this.$refs.GoodsInfo.productType,
        packingPiece: this.goodsInfo.packingPiece,
      ...
      if (sendOrder || this.isEdit || this.isAgain) {
        if (JSON.stringify(this.editData) != '{}') {var _this$editData =
          ...
          self.$nextTick(function () {
            ...
            this.$refs.GoodsInfo.productType = productType || '';
            this.editProductType = productType ? true : false;
            if (groupId) {
...
/***/ 92:
/*!*********************************************************************************************************************!*\
  !*** E:/idea-work/imwj/WeChat/pages/order/send/index.vue?vue&type=style&index=0&id=fb1e2936&lang=scss&scoped=true& ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
